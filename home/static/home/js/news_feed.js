...
function showVolatileNews(){
	data = {}

	requestPostData("/agri_req/getVolatilityNewsFeed", {"data": data})
	.then(data=> {
		
		news_data = data["news"];
		setVolatileNews(news_data);
...
function setVolatileNews(vol_news_data){
	var html = ``;
...
function requestVolatilityModal(commodity_name){
...
////////////////// show anomalous news, news only available

function showNonAnomalousAndArticleNews(){
	data = {}

	requestPostData("/agri_req/getNonAnomalousAndArticleNewsFeed", {"data": data})
	.then(data=> {
...
function setNonAnomalousAndArticleNews(news_data){
	var html = ``;
	console.log(news_data);
...
//////////
// Anomaolous and news article
/////////

function showAnomalousAndArticleNews(){
	data = {}

	requestPostData("/agri_req/getAnomalousAndArticleNewsFeed", {"data": data})
	.then(data=> {
		
		news_data = data["news"];
		setAnomalousAndArticleNews(news_data);
...
function setAnomalousAndArticleNews(news_data){
	var html = ``;
	console.log(news_data);
	for(var i = 0; i < news_data.length; i++){
		data = news_data[i]
...
//////////
// Anomaolous and not news article
/////////
function showAnomalousAndNoArticleNews(){
	data = {}

	requestPostData("/agri_req/getAnomalousAndNoArticleNewsFeed", {"data": data})
	.then(data=> {
		
		news_data = data["news"];
		setAnomalousAndNoArticleNews(news_data);
...
function setAnomalousAndNoArticleNews(news_data){
	var html = ``;
	console.log(news_data);
	for(var i = 0; i < news_data.length; i++){
		data = news_data[i]
